...
<div className="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
      ...
      {/* <!-- Dropdown menu --> */}
      <div className={`z-50 ${hide ? 'hidden' : ''} my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600`} id="user-dropdown" >
        ...
        <ul className="py-2" aria-labelledby="user-menu-button">
          ...
          <li>
            <button href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Log out</button>
            </li>
        </ul>
      </div>
